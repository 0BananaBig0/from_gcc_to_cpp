...
set TDR_TOP_RESET {TDR_TOP_RESET.tdr}
set Block_1_RESET_TDR {Block_1.TDR_1_RESET.tdr}
set Block_2_RESET_TDR {Block_2.TDR_1_RESET.tdr}
if {[regexp {test_Hier_Local_Reset_Structure_Like_Self_Clear} $script_path]} {
    set TDR_TOP_RESET {TDR_TOP_RESET.tdr.EN}
    set Block_1_RESET_TDR {Block_1.TDR_1_RESET.tdr.EN}
    set Block_2_RESET_TDR {Block_2.TDR_1_RESET.tdr.EN}
}
...
iRead Block_2.TDR_2.tdr[8:3] 0b000000
# iRead Block_2.TDR_3.tdr[8:3] 0b000000
iNote "Write 100 to Block_1."
iApply

iWrite $Block_2_RESET_TDR 0b11
...
iNote "Reset Block_1 and Block_2."
iApply

iWrite $TDR_TOP_RESET 0b11
# iRead Block_1.TDR_2.tdr[8:3] 0b000000
# iRead Block_1.TDR_3.tdr[8:3] 0b000000
# iRead Block_2.TDR_2.tdr[8:3] 0b000000
# iRead Block_2.TDR_3.tdr[8:3] 0b000000
iNote "Manually unreset Block_1 and Block_2."
iApply
